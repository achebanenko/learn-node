...
function searchResultsHTML(stores) {
  return stores.map(function (store) {
    return "<a href=\"/store/".concat(store.slug, "\" class=\"search__result\"><strong>").concat(store.name, "</strong><a/>");
  }).join('');
}
...
function typeAhead(search) {
  ...
  var searchResults = search.querySelector('.search__results'); // let i
  ...
  searchInput.on('input', function () {
    ...
    searchResults.style.display = 'block'; // i = undefined
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/search?q=".concat(this.value)).then(function (res) {
      if (res.data.length) {
        ...
        searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize(html);
        return;
      }
  ...
  searchInput.on('keyup', function (e) {
    ...
    next.classList.add(activeClass); // my variant
...
(0,_modules_typeAhead__WEBPACK_IMPORTED_MODULE_2__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('.search'));
(0,_modules_map__WEBPACK_IMPORTED_MODULE_3__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('#map'));
